...
mongoose.connect('mongodb://127.0.0.1:27017/webblognodejs', {
    ...
    .then(async () => {
        ...
        try {
            ...
            await User.create([
                { username:"Hoàng Phúc",email: "buivanphuc152003@1", password: hashedPassword1 },
                { username:"Bá Nhã",email: "banha@1", password: hashedPassword2 },
            ]);
            ...
            const educationCategory = categories.find(cat => cat.name === 'education');
            // Thêm dữ liệu cho Post
            await Post.create([
                {
                    title: "Cách xây dựng ứng dụng Node.js",
                    body: "Hướng dẫn từng bước để xây dựng một ứng dụng Node.js.",
                    category: financeCategory, // Tham chiếu đến category đầu tiên
                    date: "22/05/2003",
                ...
                },
                {
                    ...
                    category: educationCategory, // Tham chiếu đến category thứ hai
                    date: "22/05/2003",
                    imageURL: "banner_img1.png",
                },
